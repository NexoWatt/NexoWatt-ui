...
export type ConnectionStateReason = 'server-started' | 'webserver-started' | 'heartbeat' | 'server-error' | 'webserver-error' | 'server-closed' | 'adapter-unload' | 'unload' | 'startup-error' | 'startup-failed';
