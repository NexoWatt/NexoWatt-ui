...
export type BudgetLimitReason = 'pv-surplus' | 'grid-limit' | 'storage-reserve' | 'peak-shaving' | 'para14a' | 'manual-limit' | 'missing-input' | 'none';
...
//# sourceMappingURL=ems-budget.d.ts.map