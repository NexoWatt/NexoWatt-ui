...
function runBrandHeaderCleanupTest(): void {
  ...
  assert(read('src-ts/runtime-executables/www/sw.ts').includes("nexowatt-cache-v321"), 'Service-Worker-TS-Quelle muss Cache v321 nutzen.');
  assert(read('www/sw.js').includes("nexowatt-cache-v321"), 'Generierter Service Worker muss Cache v321 nutzen.');
}
