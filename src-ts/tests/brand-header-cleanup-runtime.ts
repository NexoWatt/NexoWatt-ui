...
function runBrandHeaderCleanupTest(): void {
  ...
  assert(read('src-ts/runtime-executables/www/sw.ts').includes("nexowatt-cache-v312"), 'Service-Worker-TS-Quelle muss Cache v312 nutzen.');
  assert(read('www/sw.js').includes("nexowatt-cache-v312"), 'Generierter Service Worker muss Cache v312 nutzen.');
}
