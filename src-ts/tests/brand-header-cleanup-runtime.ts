...
function runBrandHeaderCleanupTest(): void {
  ...
  assert(read('src-ts/runtime-executables/www/sw.ts').includes("nexowatt-cache-v311"), 'Service-Worker-TS-Quelle muss Cache v310 nutzen.');
  assert(read('www/sw.js').includes("nexowatt-cache-v311"), 'Generierter Service Worker muss Cache v310 nutzen.');
}
