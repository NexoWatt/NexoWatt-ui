...
function runBrandHeaderCleanupTest(): void {
  ...
  assert(read('src-ts/runtime-executables/www/sw.ts').includes("nexowatt-cache-v313"), 'Service-Worker-TS-Quelle muss Cache v313 nutzen.');
  assert(read('www/sw.js').includes("nexowatt-cache-v313"), 'Generierter Service Worker muss Cache v313 nutzen.');
}
