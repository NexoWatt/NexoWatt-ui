...
interface AdapterLike {
  ...
  _nwGetSystemGeo?: () => Promise<{ lat?: unknown; lon?: unknown } | null>;
...
async function resolveLocation(adapter: AdapterLike, settings: RuntimeSettings): Promise<{ latitude: number; longitude: number } | null> {
...
function invalidSnapshot(nowMs: number, error: string, settings?: RuntimeSettings): OpenMeteoPvSnapshot {
  return {
