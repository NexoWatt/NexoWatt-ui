...
(function initForecastSettings(){
  ...
  const updateVisibility = (): void => {
    const source = String(byId<HTMLSelectElement>('s_forecastSourceMode')?.value || stateValue('settings.forecastSourceMode', 'auto') || 'auto');
    const enabledInput = byId<HTMLInputElement>('s_openMeteoPvEnabled');
