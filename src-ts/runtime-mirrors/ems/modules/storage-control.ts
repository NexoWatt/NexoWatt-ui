 ...
 *
 * Original-Hash: ef114a1caf8ece6bd5930ad450a841498c20a1416ae447eef5633951a5da622b
 */
 ...
 * Quell-Hash: sha256:3be0c12bc621b62c036d8a58836824d114aa8a85fe2dededf64593e9fac11b82
...
/**
 * Code-Teil: resolveStorageGridChargeFinalGate
 *
 * Zweck:
...
/**
 * Code-Teil: resolveEvcsProtectedStorageTarget
 *
 * Zweck:
 * Automatisch markierter Funktion-Abschnitt aus der ursprünglichen JavaScript-Datei.
 * Dieser Kommentar dient als Orientierung für die schrittweise TypeScript-Migration.
...
const _prevRampW = (typeof this._lastTargetW === 'number' && Number.isFinite(this._lastTargetW)) ? this._lastTargetW : 0;
{
    ...
    // Das ist sicherheitsrelevant für PV-Wolken, wegfallenden Netz-Headroom und EV-Priorität.
        ...
        if (targetW === 0) {
            const lastActiveTargetW = strictFiniteNumber(this._lastTargetW, 0);
