// @ts-nocheck
/**
 * TypeScript-Parallelspiegel: scripts/verify-storage-pv-load-feedforward-zero-stop.js
 *
 * Zweck:
 * Diese Datei ist die TypeScript-Vorbereitung der bestehenden JavaScript-Runtime-Datei.
 * Sie wird noch nicht produktiv ausgeführt. Die produktive Quelle bleibt vorerst:
 * scripts/verify-storage-pv-load-feedforward-zero-stop.js
 *
 * Zusammenhang:
