 ...
 *
 * Original-Hash: 288948cd89d795287e752376cbc6615b31ad64f8b8ed65fe261d03aadd6f466e
 */
 ...
 * `.nwcore/**` oder `www/**` gearbeitet wird.
 */
const fs = require('fs');
...
function runtimeRelForSource(sourceAbs) {
  ...
  return jsRel.startsWith('nwcore/') ? `.nwcore/${jsRel.slice('nwcore/'.length)}` : jsRel;
}
...
if (checkOnly) {
  checkRuntimeFilesAgainstSourceHeaders();
  process.exit(0);
}
