 ...
 */
function diagnostic(feature, visible, reasonDe) {
 ...
 */
export function buildCustomerFeatureDiagnostics(input) {
    ...
    return [
        diagnostic('evcs', v.hasEvcs, v.hasEvcs
        ...
        diagnostic('smartHome', v.hasSmartHome, v.hasSmartHome
        ...
        diagnostic('weather', v.hasWeather, v.hasWeather
        ...
        diagnostic('aiAdvisor', v.hasAiAdvisor, v.hasAiAdvisor
 ...
 */
export function featureVisibilitySummaryText(diagnostics) {
